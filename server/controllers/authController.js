  ...
  try {
    ...
    const user = await User.findOne({
      ...
      include: [
        {
          model: Company,
          as: "company", // Ensure alias matches the model definition
          attributes: ["name"], // Fetch only the company name
          required: false, // Allow users without a company to log in
        },
      ],
    });
    ...
    const userResponse = {
      ...
      companyName: user.company?.name || "N/A", // Use safe navigation
