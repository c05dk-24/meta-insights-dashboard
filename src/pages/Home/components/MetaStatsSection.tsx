      ...
      <div className="grid grid-cols-2 gap-4">
        {[1, 2, 3, 4].map((i) => (
          <div key={i} className="bg-white dark:bg-gray-800 rounded-2xl p-6 animate-pulse">
            <div className="h-8 bg-gray-200 dark:bg-gray-700 rounded-lg w-24 mb-4" />
            <div className="h-6 bg-gray-100 dark:bg-gray-600 rounded w-16" />
          </div>
        ))}
      </div>
    );
    ...
    <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-lg">
      ...
      <div className="grid grid-cols-2 gap-4">
        {stats.map((stat, index) => (
          <div
            key={index}
            className="bg-gray-50 dark:bg-gray-700/50 rounded-xl p-4 backdrop-blur-sm"
          >
